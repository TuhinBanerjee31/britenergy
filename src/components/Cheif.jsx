      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-in">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">{props.data && props.data.content}</p>
          </div>

          {/* Right Profile Card */}
          <div className="bg-gray-900 text-white p-8 rounded-2xl relative shadow-xl animate-fade-in">
            <img
              src={props.data && props.data.pic}
            ...
            <div className="mt-20">
              ...
              <div className="space-y-2 mb-8">
                {props.data && props.data.address.map(item => (<p className="text-gray-300" key={item}>{item}</p>))}
              </div>
