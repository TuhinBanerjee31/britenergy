...
const Overview = () => {
  return (
    <div className="min-h-screen font-roboto-condensed bg-[#f2f8fd]">
      <div className="flex items-center p-8 md:p-32">
        <div className="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Text Section */}
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl sm:text-5xl lg:text-8xl text-[#102a41]">
              WE BUILD WITH PURPOSE
            </h1>
            <h2 className="text-4xl sm:text-5xl lg:text-5xl font-light text-[#184262] mt-2 md:mt-4">
              THIS IS WHAT DEFINES US
            </h2>
            <h2 className="text-4xl sm:text-5xl lg:text-5xl font-light text-[#184262] mt-2 md:mt-4">
              AND FUELS OUR PASSION
            </h2>
            <p className="text-[#174e75] mt-4 md:mt-6 text-lg sm:text-2xl">
