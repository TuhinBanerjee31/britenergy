...
const Overview = () => {
  return (
    <div className="min-h-screen font-roboto-condensed bg-[#EBEBEB]">
      <div className="flex items-center p-16 md:p-32">
        <div className="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light text-gray-800 mt-4">
              IT'S WHO WE ARE
            </h2>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light text-gray-800 mt-4">
              AND WHAT WE DO.
            ...
            <div>
              <button className="button-48 py-10">
                <span className="text">ABOUT BRITENERGY</span>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <img
              ...
              className="w-full h-full object-cover rounded-lg shadow col-span-2"
            />
