      ...
      <div className="max-w-screen-xl mx-auto pt-20">
        ...
        <div className="flex flex-wrap justify-center w-full gap-10">
          {projectsData.map((item) => (
            <Link to={item.redirect} state={item} key={item.id} className="flex flex-col gap-0.5">
              <img
                src={item.imgUrl}
